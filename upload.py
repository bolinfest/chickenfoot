...
group.add_option("-s", "--server", action="store", dest="server",
                 default="bolinfest-rietveld.appspot.com",
                 metavar="SERVER",
...
group.add_option("--cc", action="store", dest="cc",
                 metavar="CC", default="chickenfoot-developers@csail.mit.edu",
                 help="Add CC (comma separated email addresses). Defaults to '%default'.")
