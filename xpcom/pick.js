 ...
 */
function pickImpl(/*Document*/doc, /*listPattern,choicePattern,checked*/args, /*optional Range*/ context) {
  args = expandArguments(args, true);
  doPick(doc, args[0], args[1], args[2], context);
}
 ...
 * Throws exception if ambiguity or failure to match.
 */
function unpickImpl(/*Document*/doc, /*listPattern,choicePattern,checked*/args, /*optional Range*/ context) {
...
function doPick (/*Document*/doc, 
  ...
  simulatePick(bestMatch.element, value);
}
