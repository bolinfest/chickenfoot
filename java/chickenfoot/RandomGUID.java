/*
 *  From: http://javaexchange.com/aboutRandomGUID.html
 *  
 *  Refactored to use a static creation method instead of a public constructor
 *  Also made the class final
 */
...
public final class RandomGUID extends Object {
    ...
    public static String createRandomGUID() {
        return createRandomGUID(false);
    }
    
    public static String createRandomGUID(Boolean secure) {
        RandomGUID guid = new RandomGUID(secure);
